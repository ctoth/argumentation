...
The preprocessing layer (:mod:`argumentation.preprocessing`) must be exactly
...
that against the brute-force reference semantics in :mod:`argumentation.dung`
...
from argumentation.dung import complete_extensions as native_complete_extensions
from argumentation.dung import ideal_extension as native_ideal_extension
from argumentation.preprocessing import (
    AfSimplification,
