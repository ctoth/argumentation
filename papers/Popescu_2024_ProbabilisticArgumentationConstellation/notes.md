...
- [Reasoning in Assumption-Based Argumentation Using Tree-Decompositions](../Popescu_2023_ReasoningAssumption-BasedArgumentationTree-Decompositions/notes.md) - same authors' ABA tree-decomposition predecessor; it establishes the direct DP route over ABA instances that this paper's probabilistic AF algorithms conceptually parallel.
...
- **Tree-decomposition DP for argumentation:**
  ...
  - [Reasoning in Assumption-Based Argumentation Using Tree-Decompositions](../Popescu_2023_ReasoningAssumption-BasedArgumentationTree-Decompositions/notes.md) — **Strong.** Both papers use bounded-treewidth DP for argumentation; the 2023 paper works over flat ABA with witness/counterwitness state, while this paper moves the same structural idea into probabilistic AF computation.
